...
def defence(char_name: str, char_class: str) -> str:
    ...
    return 'Не блокировал атаку'


def special(char_name: str, char_class: str) -> str:
    """Вывод информации об умении."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    ...
    print('attack—атаковать,defence—блокировать,special—умение')
...
def choice_char_class() -> str:
    ...
    while approve_choice != 'y':
        print('За какаого персонажа хочешь играть: ')
        char_class = input('Воитель — warrior, Маг — mage, Лекарь — healer.')
        if char_class == 'warrior':
            print('Воитель — ближнего боя. Сильный, выносливый и отважный.')
        if char_class == 'mage':
            print('Маг — Дальнего боя. Обладает высоким интеллектом.')
        if char_class == 'healer':
